...
- (void)changeBannerFrequencyWithFrequency:(jint)frequency {
  [((ImActorModelModulesSettings *) nil_chk([((ImActorModelModulesModules *) nil_chk(modules_)) getSettings])) changeBannerFrequencyWithInt:frequency];
}

- (jint)getBannerFrequency {
  return [((ImActorModelModulesSettings *) nil_chk([((ImActorModelModulesModules *) nil_chk(modules_)) getSettings])) getBannerFrequency];
}
