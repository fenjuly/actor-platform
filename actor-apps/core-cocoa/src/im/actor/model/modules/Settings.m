...
- (jdouble)loadValueWithNSString:(NSString *)key
                      withDouble:(jdouble)defaultVal;
...
__attribute__((unused)) static jdouble ImActorModelModulesSettings_loadValueWithNSString_withDouble_(ImActorModelModulesSettings *self, NSString *key, jdouble defaultVal);
...
- (jint)getBannerFrequency {
  jdouble val = ImActorModelModulesSettings_loadValueWithNSString_withDouble_(self, KEY_BANNER_FREQUENCY_, 0.5);
  return J2ObjCFpToInt((val * 100));
}

- (jdouble)loadValueWithNSString:(NSString *)key
                      withDouble:(jdouble)defaultVal {
  return ImActorModelModulesSettings_loadValueWithNSString_withDouble_(self, key, defaultVal);
}
...
void ImActorModelModulesSettings_initWithImActorModelModulesModules_(ImActorModelModulesSettings *self, ImActorModelModulesModules *modules) {
  ...
  self->KEY_BANNER_FREQUENCY_ = @"llectro.banners.frequency";
}
...
jdouble ImActorModelModulesSettings_loadValueWithNSString_withDouble_(ImActorModelModulesSettings *self, NSString *key, jdouble defaultVal) {
  NSString *sValue = ImActorModelModulesSettings_readValueWithNSString_(self, key);
  jdouble value = defaultVal;
  if (sValue != nil) {
    @try {
      value = [((NSNumber *) nil_chk([((JavaTextNumberFormat *) nil_chk(JavaTextNumberFormat_getInstanceWithJavaUtilLocale_(JavaUtilLocale_get_ENGLISH_()))) parseWithNSString:sValue])) doubleValue];
    }
